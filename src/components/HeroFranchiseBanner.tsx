    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center justify-between">
        <div className="w-full lg:w-1/2 text-white mb-16 lg:mb-0">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[64px] font-extrabold leading-[1.1] mb-6 tracking-tight drop-shadow-lg">
            Own India&apos;s Top <br />
          ...
          <p className="text-xl md:text-2xl text-white mb-8 font-semibold leading-relaxed drop-shadow-md">
            <span className="border-l-4 border-amber-500 pl-4 py-1 block bg-black/20 rounded-r-lg">
              45% Profit Margins | 100% Financing | 18-24 Month Payback
            </span>
          </p>
          <div className="flex flex-col space-y-4 text-gray-100 mb-10 drop-shadow-md">
            ...
            <div className="flex items-center">
              <i className="fas fa-hexagon text-amber-400 mr-3" />{" "}
              <span className="font-medium text-lg">Banking Partnerships for Easy Financing</span>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-8">
            ...
            <Link
              to="https://honeymanstore.com/wp-content/uploads/2025/12/Honeyman-Magazine-1.pdf"
